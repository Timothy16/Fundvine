// server/api/mutual-funds/index.get.ts
...
export default defineEventHandler(async (event) => {
  try {
    ...
    const response = await $fetch(`${config.apiBaseUrl}/api/client/v2/funds/active-mutual-funds`, {
      method: 'GET',
      headers: {
    ...
    if (error.response) {
      ...
      throw createError({
        ...
        statusMessage: error.response._data?.message || 'Failed to fetch mutual funds',
